...
let filterEven = (arr) => {return arr.filter(n => isEven(n))};
...
let filterOdd = (arr) => {return arr.filter(n => isOdd(n))};
...
let mapIncrement = (arr) => {return arr.map(n => plusOne(n))};
...
let mapTriple = (arr) => {return arr.map(n => timesThree(n))};
...
let reduceSum = (arr) => {return arr.reduce((n1, n2) => add(n1, n2))};
...
let reduceProduct = (arr) => {return arr.reduce((n1, n2) => multiply(n1, n2))};
